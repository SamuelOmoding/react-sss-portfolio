  ...
  via-blue to-black text-white">
    ...
    justify-center w-full h-full">
       ...
       {  `I'm a dynamic individual with a passion for frontend 
          ...
          my expertise lies in crafting engaging web applications 
          using technologies like React, Tailwind, and HTML. 
          My creativity shines through in my work, as he 
